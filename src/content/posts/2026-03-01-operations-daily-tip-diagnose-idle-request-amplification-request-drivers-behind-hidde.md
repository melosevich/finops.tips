...
title: "Diagnose idle request amplification request drivers behind hidden cloud spend"
description: "Quantify idle request amplification request telemetry and per-call cost baselines to remove high-volume waste before month-end close."
image:
...
## Example
If idle request amplification request intensity jumps after a release, gate rollout, assign the owning team, and enforce a rollback or optimization plan before traffic returns to full volume. Source: [FinOps Foundation operations playbook](https://www.finops.org/framework/capabilities/workload-optimization/).
