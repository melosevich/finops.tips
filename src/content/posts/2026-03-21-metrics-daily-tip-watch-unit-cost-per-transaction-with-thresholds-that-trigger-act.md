...
title: "Watch unit cost per transaction with thresholds that trigger action"
description: "Instrument unit cost per transaction with owner-level thresholds, confidence bands, and an explicit remediation SLA."
image:
